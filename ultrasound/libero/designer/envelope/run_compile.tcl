...
set_partition_info -name "/envelope" -timestamp "1755081717"
set_partition_info -name "/envelope/envelope" -timestamp "1755081717"
set_compile_info \
...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"/home/jessica/Desktop/lultrasound_ibero/envelope_detection/synthesis/envelope.vm"}
set_compile_info \
    -category {"Options"} \

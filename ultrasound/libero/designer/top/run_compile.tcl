...
set_partition_info -name "/top" -timestamp "1757015703"
set_partition_info -name "/top/top" -timestamp "1757015703"
set_partition_info -name "/top/top" -timestamp "1757015703"
set_compile_info \
...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"/home/jessica/GITHUB/EchoCore/ultrasound/libero/synthesis/top.vm"}
set_compile_info \
    -category {"Options"} \
